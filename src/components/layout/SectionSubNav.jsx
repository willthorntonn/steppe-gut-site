    ...
    >
      {links.map((link) => (
        <NavLink
          ...
          className={({ isActive }) =>
            `shrink-0 snap-start whitespace-nowrap font-sans font-semibold tracking-[-0.01em] transition-colors focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-gold ${
