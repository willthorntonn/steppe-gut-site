...
export default function SteppeArmyProgress() {
  ...
  return (
    ...
    >
      <div
        ref={ref}
        className="mx-auto max-w-[2000px] px-6 pb-8 pt-16 sm:px-10 sm:pb-10 sm:pt-20 lg:px-14 lg:pb-12 lg:pt-24"
      >
        <div className="border-y border-forest/15 py-10 sm:py-12 lg:py-14">
          <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between lg:gap-16">
            <div className="min-w-0">
              <p className="font-sans text-sm uppercase tracking-[0.3em] text-forest/45 lg:text-base">
                The Steppe Army
              </p>
              <h2
                className="mt-5 max-w-[20ch] font-serif font-normal leading-[1.04] tracking-[-0.04em] text-forest"
                style={{ fontSize: "clamp(2.45rem, 5.2vw, 4.9rem)" }}
              >
                Ten thousand Steppe Soldiers.
              </h2>
              <p
                className="mt-5 max-w-[46ch] font-serif text-forest/75"
                style={{ fontSize: "clamp(1.2rem, 1.6vw, 1.5rem)", lineHeight: 1.65 }}
              >
                Everyone who drinks Steppe Gut each morning is a Steppe
                Soldier. Here&apos;s how close we are.
              </p>
            </div>

            <button
              type="button"
              className="inline-flex h-14 w-full shrink-0 items-center justify-center rounded-2xl border border-forest bg-forest px-8 font-sans text-[21px] font-bold tracking-[-0.02em] text-cream transition-colors hover:bg-cream hover:text-forest focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold sm:w-auto lg:h-16 lg:px-11 lg:text-[26px]"
            >
