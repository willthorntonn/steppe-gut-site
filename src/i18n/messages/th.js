...
export default {
  ...
  // ----------------------------------------------------- scienceMission --
  "scienceMission.SCIENCE_MISSION.heading": "พันธกิจด้านวิทยาศาสตร์ของเรา",

  "scienceMission.SCIENCE_MISSION.intro.heading": "ขับเคลื่อนด้วยวิทยาศาสตร์",
  "scienceMission.SCIENCE_MISSION.intro.body":
    "ทุกบรรทัดบนหน้านี้ตั้งอยู่บนวิทยาศาสตร์การนมที่ได้รับการยอมรับ และงานวิจัยที่มีมากขึ้นเรื่อย ๆ เกี่ยวกับนมม้าหมัก ซึ่งส่วนใหญ่มาจากมองโกเลีย เอเชียกลาง และยุโรปตะวันออก เราทำงานร่วมกับนักวิทยาศาสตร์ด้านอาหารอิสระ ที่อ่านหลักฐานเหล่านั้นไปพร้อมกับเรา และคอยกำกับให้เราอธิบายผงนี้เฉพาะในขอบเขตที่หลักฐานรองรับเท่านั้น",
  "scienceMission.SCIENCE_MISSION.intro.aside":
    "การหมักและการทำให้แห้งอย่างนุ่มนวลเป็นเคมีอาหารธรรมดาที่เข้าใจกันดี และทุกล็อตถูกวัดเทียบกับเกณฑ์มาตรฐานเดียวกันก่อนออกจากโรงงาน การขึ้นทะเบียนกับสำนักงานคณะกรรมการอาหารและยาของไทยได้รับอนุมัติแล้ว ใบรับรองรองรับอยู่เบื้องหลังทุกแพ็ค และสิ่งใดที่หลักฐานรองรับเพิ่มขึ้นใหม่ เราจะเผยแพร่ที่นี่ก่อน นำหน้าที่อื่นใด",
  "scienceMission.SCIENCE_MISSION.intro.image.description":
    "อาคารวิจัยและห้องปฏิบัติการกระจกใสใต้ท้องฟ้าสีครามกว้างใหญ่ มุมเงยจากด้านล่าง มีต้นไม้เรียงรายตามฐานอาคาร แสงกลางวันเป็นกลาง ไม่มีแบรนด์",
  "scienceMission.SCIENCE_MISSION.intro.image.alt":
    "อาคารห้องปฏิบัติการวิจัยกระจกใสใต้ท้องฟ้าสีครามกว้างใหญ่",

  "scienceMission.SCIENCE_MISSION.heroImage.description":
    "ซองผงนมหมักสีจางและจานตัวอย่างขนาดเล็กบนโต๊ะห้องปฏิบัติการ แสงกลางวันเป็นกลาง มีเอกสารการวิเคราะห์เบลออยู่ด้านหลัง ไม่มีแบรนด์",
  "scienceMission.SCIENCE_MISSION.heroImage.alt":
    "ตัวอย่างผงนมม้าหมักบนโต๊ะห้องปฏิบัติการ",

  "scienceMission.SCIENCE_MISSION.fields.items.0.heading": "องค์ประกอบ",
  "scienceMission.SCIENCE_MISSION.fields.items.0.body":
    "สิ่งที่อยู่ในแต่ละล็อต วัดจริงไม่ใช่คาดเดา ทั้งความชื้น โปรตีน ไขมัน แลคโตส วิตามินซี โลหะหนัก และสารก่อภูมิแพ้ ล้วนผ่านการตรวจ ใบรับรองขอดูได้เมื่อร้องขอ ระหว่างที่การวิเคราะห์รายล็อตกำลังเตรียมเผยแพร่",
  "scienceMission.SCIENCE_MISSION.fields.items.0.image.description":
    "ภาพระยะใกล้มุมสูงของผงนมหมักสีจางในจานชั่งน้ำหนัก ข้าง ๆ มีแผ่นผลวิเคราะห์ที่พิมพ์ออกมา แสงนุ่มสม่ำเสมอ",
  "scienceMission.SCIENCE_MISSION.fields.items.0.image.alt":
    "ผงนมหมักในจานชั่งน้ำหนักข้างแผ่นผลวิเคราะห์ที่พิมพ์ออกมา",

  "scienceMission.SCIENCE_MISSION.fields.items.1.heading": "การหมัก",
  "scienceMission.SCIENCE_MISSION.fields.items.1.body":
    "สิ่งที่เชื้อจุลินทรีย์ทำก่อนการทำให้แห้ง และมีมากเท่าใดที่รอดผ่านกระบวนการมาได้ เราติดตามความเป็นกรดและโครงสร้างโปรตีนตลอดการหมักและการทำให้แห้งที่อุณหภูมิต่ำ เพื่อให้ผงสำเร็จตรงกับการหมักที่มันมา",
  "scienceMission.SCIENCE_MISSION.fields.items.1.image.description":
    "ภาพจำลองทางวิทยาศาสตร์ของโครงสร้างโปรตีนนมและโมเลกุลกรดแลคติก แบบจำลองลูกกลมและแท่งอันประณีตบนพื้นไล่สีเขียวป่าเข้ม แสงเฉียงอบอุ่น ระยะชัดตื้นนุ่มนวล ไม่มีข้อความหรือแบรนด์",
  "scienceMission.SCIENCE_MISSION.fields.items.1.image.alt":
    "ภาพจำลองระดับโมเลกุลของโครงสร้างโปรตีนนมและกรดแลคติก",

  // ------------------------------------------------------ manufacturing --
  "manufacturing.MANUFACTURING.heading": "กระบวนการผลิต",
  "manufacturing.MANUFACTURING.intro.heading": "Steppe Gut ทำขึ้นมาอย่างไร",
  "manufacturing.MANUFACTURING.intro.body":
    "ทุกแพ็คเริ่มต้นจากม้าแม่พันธุ์บนทุ่งหญ้าเปิดในจังหวัดตูฟ ประเทศมองโกเลีย และจบลงที่ซองที่ปิดผนึกแล้ว ระหว่างนั้นมีเจ็ดขั้นตอน บางขั้นตอนมีอายุแปดร้อยปีและบางขั้นตอนทำงานบนสเตนเลสสตีล หน้านี้จะพาไปดูทุกขั้นตอน ระบุชื่อโรงงาน และแสดงส่วนของกระบวนการที่ไม่ได้สวยงามน่ามอง",
  "manufacturing.MANUFACTURING.intro.aside":
    "นมม้าสดเริ่มเปลี่ยนสภาพภายในไม่กี่ชั่วโมงหลังการรีดนม และม้าแม่พันธุ์ให้นมเฉพาะช่วงมิถุนายนถึงตุลาคมเท่านั้น ห่วงโซ่ทั้งหมดถูกสร้างขึ้นรอบข้อเท็จจริงสองข้อนี้",
  "manufacturing.MANUFACTURING.heroImage.description":
    "ภาพนิ่งการผลิตมุมกว้าง ถังนมสเตนเลสเรียงเป็นแถวตั้งพิงกำแพงฉาบปูนหยาบในแสงกลางวันเย็นตา ไม่มีแบรนด์",
  "manufacturing.MANUFACTURING.heroImage.alt":
    "ถังนมสเตนเลสเรียงเป็นแถวพิงกำแพงฉาบปูน",
  "manufacturing.MANUFACTURING.blocks.0.heading": "เริ่มต้นที่น้ำนม",
  "manufacturing.MANUFACTURING.blocks.0.imageBrief":
    "มือกร้านแดดกำลังรีดนมม้าแม่พันธุ์บนทุ่งหญ้าเปิด จัดเฟรมใกล้ที่มือและสีข้างม้า แสงข้างยามเย็นสีทอง โทนสารคดีเงียบสงบ",
  "manufacturing.MANUFACTURING.blocks.0.alt":
    "คนเลี้ยงสัตว์อยู่กับม้าบนทุ่งหญ้าเปิด",
  "manufacturing.MANUFACTURING.blocks.1.heading": "การหมักทำอะไรบ้าง",
  "manufacturing.MANUFACTURING.blocks.1.imageBrief":
    "ภายในกระโจมเกอร์ในเวลากลางวัน ภาชนะหมักไม้แบบดั้งเดิมวางที่ระดับพื้นมีไม้พายวางอยู่ในนั้น แสงอบอุ่นลอดผ่านประตู มือกำลังคนอยู่กลางคัน",
  "manufacturing.MANUFACTURING.blocks.1.alt":
    "ภาชนะหมักไม้แบบดั้งเดิมภายในกระโจมเกอร์",
  "manufacturing.MANUFACTURING.quote":
    "ราวหนึ่งสัปดาห์ระหว่างม้าแม่พันธุ์บนทุ่งหญ้าเปิดกับซองที่ปิดผนึกแล้ว และเวลาส่วนใหญ่ของสัปดาห์นั้นคือการหมัก",
  "manufacturing.MANUFACTURING.measured.heading": "ทุกล็อตถูกวัด ไม่ใช่คาดเดา",
  "manufacturing.MANUFACTURING.measured.body":
    "การหมักในภาชนะของแต่ละครอบครัวย่อมให้ความแปรปรวนมากกว่าถังอุตสาหกรรมถังเดียว เราจัดการเรื่องนี้ด้วยการตรวจทุกล็อตก่อนปล่อยออก และผสมล็อตต่าง ๆ จากภายในฤดูกาลเดียวกันเพื่อลดความต่างให้เท่ากัน โดยไม่มีสิ่งใดจากนอกฤดูกาลมิถุนายนถึงตุลาคมถูกนำมาผสมเลย ความชื้น โปรตีน ไขมัน แลคโตส วิตามินซี โลหะหนัก และสารก่อภูมิแพ้ที่ระบุไว้ ล้วนผ่านการตรวจ และใบรับรองการวิเคราะห์ขอดูได้เมื่อร้องขอ",
  "manufacturing.MANUFACTURING.measured.imageBrief":
    "ภาพถ่ายเชิงบรรณาธิการเรียบง่ายของเครื่องชั่งวิเคราะห์บนโต๊ะห้องปฏิบัติการที่แสดงมวลเล็กน้อยเป็นกรัม มือสวมถุงมือกำลังวางตัวอย่างลงบนจานชั่ง มีกระบอกตวงอยู่ข้าง ๆ แสงกลางวันเย็นตา โทนตรงไปตรงมา",
  "manufacturing.MANUFACTURING.measured.alt":
    "ตัวอย่างกำลังถูกชั่งบนเครื่องชั่งวิเคราะห์ในห้องปฏิบัติการ",
  "manufacturing.MANUFACTURING.stepsHeading": "เจ็ดขั้นตอน จากถังนมถึงซอง",
  "manufacturing.MANUFACTURING.steps.0.title": "การรีดนม",
  "manufacturing.MANUFACTURING.steps.0.body":
    "ม้าแม่พันธุ์ถูกรีดนมในช่วงสั้น ๆ หลายครั้งต่อวันบนพื้นที่โล่ง เคียงข้างลูกม้า ปริมาณต่อครั้งน้อย และการรีดแบบนี้ไม่อาจขยายเข้าโรงรีดนมได้",
  "manufacturing.MANUFACTURING.steps.1.title": "การกรองและการทำให้เย็น",
  "manufacturing.MANUFACTURING.steps.1.body":
    "น้ำนมถูกกรองผ่านผ้าและทำให้เย็นเท่าที่สภาพแวดล้อมจะเอื้อ จากนั้นจัดการอย่างรวดเร็วก่อนที่มันจะเริ่มเปลี่ยนสภาพ",
  "manufacturing.MANUFACTURING.steps.2.title": "การหมัก",
  "manufacturing.MANUFACTURING.steps.2.body":
    "ลงสู่ถังไม้ที่มีเชื้อจุลินทรีย์ตั้งต้นอยู่แล้ว สี่วัน คนด้วยมือหลายครั้งต่อวัน ไม่มีการเติมเชื้อจากซองสำเร็จรูป ไม่มีการควบคุมอุณหภูมินอกจากร่มเงา",
  "manufacturing.MANUFACTURING.steps.3.title": "การรวบรวม",
  "manufacturing.MANUFACTURING.steps.3.body":
    "นมหมักถูกรวบรวมจากครอบครัวต่าง ๆ ตามกำหนดเวลาที่แน่นอนตลอดฤดูกาล และขนส่งแบบแช่เย็นไปยังโรงงานนอกเมืองอูลานบาตอร์",
  "manufacturing.MANUFACTURING.steps.4.title": "การทำให้แห้งที่อุณหภูมิต่ำ",
  "manufacturing.MANUFACTURING.steps.4.body":
    "น้ำถูกกำจัดออกที่อุณหภูมิต่ำแทนการต้ม ซึ่งช่วยปกป้ององค์ประกอบที่ไวต่อความร้อน โดยเฉพาะวิตามินซี ขั้นตอนนี้ยังยุติจุลินทรีย์มีชีวิตด้วย และเราพูดเรื่องนี้อย่างตรงไปตรงมา",
  "manufacturing.MANUFACTURING.steps.5.title": "การตรวจและการผสม",
  "manufacturing.MANUFACTURING.steps.5.body":
    "แต่ละล็อตถูกตรวจก่อนปล่อยออก ล็อตจากภายในฤดูกาลเดียวกันถูกนำมาผสมเพื่อลดความแปรปรวนให้เท่ากัน และไม่มีสิ่งใดจากนอกฤดูกาลถูกนำมาผสม",
  "manufacturing.MANUFACTURING.steps.6.title": "การบรรจุและการปิดผนึก",
  "manufacturing.MANUFACTURING.steps.6.body":
    "ผงถูกบรรจุลงในซอง แคปซูล หรือถุงภายใต้ความชื้นที่ควบคุมไว้ และปิดผนึก เลขล็อตและฤดูกาลถูกพิมพ์ไว้บนทุกแพ็ค",
  "manufacturing.MANUFACTURING.makers.heading": "ระบุชื่อ ไม่ใช่บอกเป็นนัย",
  "manufacturing.MANUFACTURING.makers.imageBrief":
    "ภาพถ่ายเชิงบรรณาธิการเรียบง่ายของอุปกรณ์ทำให้แห้งที่อุณหภูมิต่ำสเตนเลสสตีลปัดผิวด้านในห้องผลิตที่สะอาดเรียบง่าย แสงกลางวันเย็นตา ไม่มีผู้คน โทนอุตสาหกรรมตรงไปตรงมา",
  "manufacturing.MANUFACTURING.makers.alt":
    "อุปกรณ์ทำให้แห้งสเตนเลสสตีลในห้องผลิตเรียบง่าย",
};
